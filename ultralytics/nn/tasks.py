...
from .modules.Addmodules.CSPPC import *
from .modules.iRMB import iRMB, C2f_iRMB
from .modules.Addmodules import *
from .modules.Addmodules.MLCA import *
from .modules.Addmodules.Dysample import *
from .modules.Addmodules.C2fGhostModuleDynamicConv import *
import torch
import torch.nn as nn
from .modules.Addmodules.MLLA import *
from .modules.Addmodules.ASFFhead import *
from .modules.Addmodules.PGSLA_Lite import *
from .modules.Addmodules.PGSLA import *
#from .modules.Addmodules.c2f_dcn import *
from .modules.block import C2f_DCN, DCNv2
#from .modules.Addmodules.PGSLA_full import *
#from .modules.Addmodules.DWPW import *
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        # Build strides
        m = self.model[-1]  # Detect()
        if isinstance(m, (Detect, ASFFv10Detect)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
            s = 640  # 2x min stride
            m.inplace = self.inplace
            forward = lambda x: self.forward(x)[0] if isinstance(m, (Segment, Pose, OBB)) else self.forward(x)
            if isinstance(m, (v10Detect, ASFFv10Detect)):
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB,CSPPC, C2f_iRMB, C2f_PGSLA_Lite, C2f_MLCA,C2fGhostModuleDynamicConv, C2f_PGSLA, C2f_DCN):
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect,ASFFv10Detect}:
        ...
        elif m in {MLCA, MLLAttention, PGSLA}:
            c2 = ch[f]
            args = [c2, *args]
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect,ASFFv10Detect)):
                return "detect"
